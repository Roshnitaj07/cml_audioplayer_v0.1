...
#include "CML_errormsg.c"

eRetType cml_audioplayer_init(int argc, char *argv[]);
...
eRetType cml_audioplayer_volume_control(CML_INT32 vol);
...
CML_INVALID_SEEKVALUE_EXCEEDED_DURATION : The seek value provided exceeds the duration of the audio.*/
 ...
 eRetType cml_audioplayer_seek_to(int sec );
